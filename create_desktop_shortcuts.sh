...
create_shortcut "$DESKTOP_EN" "Jaranara UI" "bash -lc 'xdg-open http://127.0.0.1:5000 || sensible-browser http://127.0.0.1:5000'"
...
create_shortcut "$DESKTOP_KO" "Jaranara UI" "bash -lc 'xdg-open http://127.0.0.1:5000 || sensible-browser http://127.0.0.1:5000'"
...
create_shortcut "$HOME/.local/share/applications" "Jaranara UI" "bash -lc 'xdg-open http://127.0.0.1:5000 || sensible-browser http://127.0.0.1:5000'"
